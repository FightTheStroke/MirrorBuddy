...
test.describe('Data Retention Cron Job - Authentication', () => {
  test('POST /api/cron/data-retention - returns 401 without authorization', async ({ request }) => {
  ...
  test('POST /api/cron/data-retention - returns 401 with invalid secret', async ({ request }) => {
    const response = await request.post('/api/cron/data-retention', {
      headers: {
  ...
  test('POST /api/cron/data-retention - returns 401 with malformed header', async ({ request }) => {
    const response = await request.post('/api/cron/data-retention', {
      headers: {
  ...
  test('POST /api/cron/data-retention - succeeds with valid secret', async ({ request }) => {
    const response = await request.post('/api/cron/data-retention', {
      headers: {
...
test.describe('Data Retention Cron Job - Method Handling', () => {
  test('GET /api/cron/data-retention - allowed in development mode', async ({ request }) => {
  ...
  test('PUT /api/cron/data-retention - method not allowed', async ({ request }) => {
  ...
  test('DELETE /api/cron/data-retention - method not allowed', async ({ request }) => {
