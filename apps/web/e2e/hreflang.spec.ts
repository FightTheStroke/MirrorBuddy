...
test.describe('hreflang tags', () => {
  test.describe('on welcome page', () => {
    ...
    test('should include Italian hreflang', async ({ page }) => {
      ...
      const itLink = await page.locator('link[rel="alternate"][hreflang="it"]').first();
    ...
    test('should include English hreflang', async ({ page }) => {
      ...
      const enLink = await page.locator('link[rel="alternate"][hreflang="en"]').first();
  ...
  test.describe('on home page', () => {
    ...
    test('should update hreflang tags when navigating between locales', async ({ page }) => {
      await page.goto('/it/welcome');
      await page.waitForTimeout(500);

      const initialLinks = await page.locator('link[rel="alternate"][hreflang="it"]').all();
