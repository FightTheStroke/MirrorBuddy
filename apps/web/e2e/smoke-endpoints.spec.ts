...
test.describe('SMOKE: Endpoint Health & Status @smoke', () => {
  ...
  test('SE-02: Health endpoint returns valid JSON structure', async ({ request }) => {
  ...
  test('SE-03: Admin dashboard route responds (with or without auth)', async ({ request }) => {
  ...
  test('SE-04: Localized admin route /it/admin responds', async ({ request }) => {
  ...
  test('SE-07: No unexpected redirects on admin routes', async ({ request }) => {
