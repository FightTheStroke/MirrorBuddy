...
test.describe('Mobile Regression Guard (375px Viewport)', () => {
  ...
  test('F-01: voice panel must be <= 30% viewport width on 375px', async ({ page, mobile }) => {
  ...
  test('F-02: sidebar must be <= 85vw on 375px viewport', async ({ page, mobile }) => {
  ...
  test('F-03: no horizontal scroll at 375px viewport', async ({ page, mobile: _mobile }) => {
    ...
    const hubDocumentWidth = await page.evaluate(() => document.documentElement.scrollWidth);

    expect(hubDocumentWidth).toBeLessThanOrEqual(hubViewportWidth);
  });

  test('F-04: voice panel responsive on landscape orientation', async ({ page, mobile }) => {
  ...
  test('F-05: sidebar dimensions consistent on homepage', async ({ page, mobile }) => {
  ...
  test('F-06: no overflow on content areas at 375px', async ({ page, mobile: _mobile }) => {
