...
test.describe('Android Pixel 7 Mobile UX', () => {
  ...
  test('sidebar width should be appropriate for Android', async ({ page, mobile }) => {
  ...
  test('touch targets should meet Android accessibility guidelines', async ({ page, mobile }) => {
  ...
  test('Chrome Android viewport units should work correctly', async ({ page, mobile: _mobile }) => {
  ...
  test('Android back button should work with sidebar', async ({ page, mobile }) => {
    ...
    const closeButton = page.locator('button[aria-label="Chiudi menu"]').first();
    const menuButton = page.locator('button[aria-label="Apri menu"]').first();
  ...
  test('Android keyboard should not obscure input fields', async ({ page, mobile: _mobile }) => {
    // Maestro buttons are in the main content area (not sidebar)
    const firstMaestro = page
      .locator('main button:has-text("Euclide"), main button:has-text("Galileo")')
      .first();
