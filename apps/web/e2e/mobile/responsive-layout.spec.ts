...
test.describe('Mobile Responsive Layout', () => {
  ...
  test('header should be visible and properly sized', async ({ page, mobile }) => {
  ...
  test('header menu button should meet touch target minimum', async ({ page, mobile }) => {
  ...
  test('notification bell should meet touch target minimum', async ({ page, mobile }) => {
  ...
  test('no horizontal scroll should be present', async ({ page }) => {
    ...
    if (result.scrollWidth > result.bodyWidth) {
      console.log('OVERFLOW DETECTED:', result.scrollWidth - result.bodyWidth, 'px');
