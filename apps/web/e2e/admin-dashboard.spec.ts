...
test.describe('Admin Feature Flags API', () => {
  ...
  test('GET with health=true includes degradation state', async ({ request }) => {
...
test.describe('Admin Degradation State', () => {
  test('Degradation state is properly structured', async ({ request }) => {
    ...
    expect(data.degradation).toBeDefined();
    expect(['none', 'partial', 'severe', 'critical']).toContain(data.degradation.level);
...
test.describe('Admin External Services Dashboard', () => {
  test('GET /api/dashboard/external-services returns usage data', async ({ request }) => {
...
test.describe('Admin Session Metrics Dashboard', () => {
  test('GET /api/dashboard/session-metrics returns metrics', async ({ request }) => {
  ...
  test('Session metrics include time-based aggregations', async ({ request }) => {
