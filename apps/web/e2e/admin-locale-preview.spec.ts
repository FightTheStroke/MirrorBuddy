...
test.describe('Admin Locale Preview Functionality', () => {
  ...
  test('F-08-01: locale preview selector is visible in admin header', async ({ page }) => {
  ...
  test('F-08-02: locale dropdown shows all supported locales', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-03: selecting locale stores preview in sessionStorage', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
    ...
    const storedLocale = await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'));
  ...
  test('F-08-04: UI content updates when locale preview changes', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
    ...
    expect(await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'))).toBe('en');
  });

  test('F-08-05: preview indicator badge is visible when preview is active', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-06: preview indicator badge has correct styling', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-07: reset button clears preview locale', async ({ page }) => {
    ...
    expect(await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'))).toBe('es');
    ...
    expect(await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'))).toBeNull();
  ...
  test('F-08-09: preview persists across page navigation in admin', async ({ page }) => {
    ...
    // Verify it's set
    expect(await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'))).toBe('fr');
  ...
  test('F-08-10: locale preview dropdown is accessible with keyboard', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-11: custom event fires when locale preview changes', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-12: locale preview dropdown styled with amber ring when active', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
  ...
  test('F-08-13: reset button only visible when preview is active', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
    ...
    const isVisibleInitially = await resetButton.isVisible({ timeout: 1000 }).catch(() => false);
  ...
  test('F-08-14: admin can switch between multiple locales rapidly', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
    ...
    for (const locale of locales) {
      ...
      const stored = await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'));
  ...
  test('F-08-15: sessionStorage is cleared on reset, not just localStorage', async ({ page }) => {
    await page.goto('/admin');
    await page.waitForLoadState('domcontentloaded');
    ...
    const beforeReset = await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'));
    ...
    const afterReset = await page.evaluate(() => sessionStorage.getItem('admin_preview_locale'));
