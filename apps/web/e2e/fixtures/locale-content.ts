...
export const contentMatchers = {
  ...
  async hasItalianText(locator: Locator): Promise<boolean> {
    ...
    const italianIndicators = ['benvenuto', 'ciao', 'impostazioni', 'profilo', 'esci'];
  ...
  async hasEnglishText(locator: Locator): Promise<boolean> {
    ...
    const englishIndicators = ['welcome', 'hello', 'settings', 'profile', 'logout'];
  ...
  async hasFrenchText(locator: Locator): Promise<boolean> {
    const text = await locator.textContent();
    // Common French words
    const frenchIndicators = ['bienvenue', 'bonjour', 'paramètres', 'profil', 'déconnexion'];
  ...
  async hasGermanText(locator: Locator): Promise<boolean> {
    const text = await locator.textContent();
    // Common German words
    const germanIndicators = ['willkommen', 'hallo', 'einstellungen', 'profil', 'abmelden'];
  ...
  async hasSpanishText(locator: Locator): Promise<boolean> {
    ...
    const spanishIndicators = ['bienvenido', 'hola', 'configuración', 'perfil', 'cerrar sesión'];
