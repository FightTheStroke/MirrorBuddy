...
describe('PII Encryption on Create', () => {
  ...
  it('encrypts Profile.name on create', async () => {
    const mockQuery = vi.fn((args) => Promise.resolve({ id: 'profile1', ...args.data }));
  ...
  it('encrypts GoogleAccount email and displayName on create', async () => {
    const mockQuery = vi.fn((args) => Promise.resolve({ id: 'ga1', ...args.data }));
  ...
  it('encrypts CoppaConsent.parentEmail on create', async () => {
    const mockQuery = vi.fn((args) => Promise.resolve({ id: 'coppa1', ...args.data }));
  ...
  it('does not modify models without PII fields', async () => {
    const mockQuery = vi.fn((args) => Promise.resolve({ id: 'conv1', ...args.data }));
