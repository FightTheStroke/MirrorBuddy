...
describe("jailbreak-flagging", () => {
  ...
  describe("getPendingReviews", () => {
    it("returns only pending attempts", async () => {
      const { flagJailbreakAttempt, getPendingReviews } =
        await import("../jailbreak-flagging");
  ...
  describe("markReviewed", () => {
    it("marks attempt as false_positive", async () => {
      const { flagJailbreakAttempt, markReviewed, getPendingReviews } =
        await import("../jailbreak-flagging");
    ...
    it("marks attempt as confirmed", async () => {
      const { flagJailbreakAttempt, markReviewed } =
        await import("../jailbreak-flagging");
    ...
    it("adds novel pattern to known patterns when requested", async () => {
      const { flagJailbreakAttempt, markReviewed, isKnownPattern } =
        await import("../jailbreak-flagging");
  ...
  describe("getJailbreakStatistics", () => {
    ...
    it("filters by period correctly", async () => {
      const { flagJailbreakAttempt, getJailbreakStatistics } =
        await import("../jailbreak-flagging");
      ...
      const _statsAfter = getJailbreakStatistics(1);
