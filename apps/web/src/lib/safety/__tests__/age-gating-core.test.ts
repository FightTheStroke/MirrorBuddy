...
import { getAgeBracket, checkAgeGate } from "../age-gating-core";
import { detectTopics, filterForAge } from "../age-gating-detection";
import { getLanguageGuidance, getAgeGatePrompt } from "../age-gating-language";
...
describe("Age Gating Core", () => {
  ...
  describe("detectTopics", () => {
    ...
    it("should detect social_romance topics", () => {
      const topics = detectTopics(
        "Il mio ragazzo mi ha detto che è innamorato",
      );
    ...
    it("should detect economics_finance topics", () => {
      const topics = detectTopics(
        "Come funziona il risparmio e gli investimenti",
      );
    ...
    it("should detect multiple topics in same text", () => {
      const topics = detectTopics("La guerra e la salute mentale nella storia");
  ...
  describe("filterForAge", () => {
    ...
    it("should detect and filter multiple sensitive topics", () => {
      ...
      const result = filterForAge("La guerra mondiale e il fidanzato", 8);
