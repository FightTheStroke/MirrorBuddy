        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="text-center p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
            <p className="text-xl font-bold text-slate-900 dark:text-white">
              <AnalyticsValue data={data} path="summary.totalEvents" />
            </p>
            <p className="text-[10px] text-slate-500">{t('total')}</p>
          </div>
          <div className="text-center p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
            <p className="text-xl font-bold text-amber-600">
              <AnalyticsValue data={data} path="summary.unresolvedCount" />
            </p>
            <p className="text-[10px] text-slate-500">{t('unresolved')}</p>
          </div>
          <div className="text-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
            <p className="text-xl font-bold text-red-600">
              <AnalyticsValue data={data} path="summary.criticalCount" />
            </p>
