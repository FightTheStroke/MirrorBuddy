...
vi.mock('@/components/ui/table', () => ({
  ...
  TableEmpty: ({ children }: { children: React.ReactNode }) => <div>{children}</div>,
}));

vi.mock('@/components/admin/responsive-table', () => ({
  ResponsiveTable: ({ children }: { children: React.ReactNode }) => <div>{children}</div>,
}));
...
describe('CampaignDetail', () => {
  ...
  it('renders campaign name and details', () => {
    render(<CampaignDetail campaign={mockCampaign} recipients={mockRecipients} />);
