...
// Mock Sentry tier context to prevent DB calls via withSentry middleware
...
describe('GDPR Data Export API', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    const request = new NextRequest(new URL('http://localhost:3000/api/privacy/export-data'), {
      method: 'GET',
    });
