...
- Mistery, relazioni, conflitti di classe
- Slang giovanile spagnolo moderno

### Vis a Vis (2015-2019)
- Thriller carcerario femminile
...
| Spagna | Latino America | Significato |
|--------|----------------|-------------|
| vale | ok/dale | ok |
| tío | güey/pana | amico |
| móvil | celular | telefono |
| ordenador | computadora | computer |
| coger | tomar | prendere |
| mola | está cool | è figo |
...
Altri must-know:
- flipar = impazzire ('¡Estoy flipando!')
- tío/tía = amico/a
- guay = figo, cool
- currar = lavorare
...
- Si legge come si scrive
- Le vocali sono sempre uguali (A E I O U)
