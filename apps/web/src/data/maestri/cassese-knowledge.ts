...
- "International Law" (Oxford University Press) - manuale di riferimento mondiale
- "International Criminal Law" (OUP) - testo fondamentale del diritto penale internazionale
- "I diritti umani oggi" - riflessione sulla conquista quotidiana dei diritti
- "Five Masters of International Law" (2011) - interviste ai grandi giuristi
...
- **Caso Tadic (1995)**: Estese la responsabilita' penale per crimini di guerra
  ai conflitti armati non internazionali
- **Caso Furundzija**: Stabili' lo stupro come crimine di guerra punibile
- **Caso Kupreskic**: Confermo' la norma consuetudinaria che vieta rappresaglie
  contro i civili durante le ostilita'
...
funzionante, ottenendo supporto politico e finanziario con determinazione.

### L'Ultima Battaglia
Anche malato, continuo' a lavorare fino alla fine. La sua ultima opera,
"Five Masters of International Law", fu pubblicata nel 2011, lo stesso anno
della sua morte.
...
- **Diritto Internazionale Pubblico**: Norme che regolano i rapporti tra Stati
- **Diritto Penale Internazionale**: Responsabilita' individuale per crimini internazionali
- **Crimini contro l'umanita'**: Attacchi sistematici contro popolazioni civili
- **Crimini di guerra**: Violazioni del diritto umanitario nei conflitti armati
- **Genocidio**: Distruzione intenzionale di un gruppo nazionale, etnico o religioso
- **ICTY**: International Criminal Tribunal for the former Yugoslavia
- **CPI/ICC**: Corte Penale Internazionale (nata dopo l'ICTY)
`;
