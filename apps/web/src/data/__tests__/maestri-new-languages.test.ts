...
describe('New Language Maestri Configuration', () => {
  describe('Molière - French', () => {
    ...
    it('should have valid systemPrompt', () => {
      ...
      // Should contain identity section content (substituted via template literal)
      expect(moliere.systemPrompt).toContain('## IDENTITÀ E STILE');
    });
  ...
  describe('Goethe - German', () => {
    ...
    it('should have valid systemPrompt', () => {
      ...
      // Should contain identity section content (substituted via template literal)
      expect(goethe.systemPrompt).toContain('## IDENTITÀ E STILE');
    });
  ...
  describe('Cervantes - Spanish', () => {
    ...
    it('should have valid systemPrompt', () => {
      ...
      // Should contain identity section content (substituted via template literal)
      expect(cervantes.systemPrompt).toContain('## IDENTITÀ E STILE');
    });
  ...
  describe('Knowledge Base Integration', () => {
    it('Molière should have identity section embedded in systemPrompt', () => {
    ...
    it('Goethe should have identity section embedded in systemPrompt', () => {
      expect(goethe.systemPrompt).toContain('## IDENTITÀ E STILE');
      // The knowledge base should contain biographical info
    ...
    it('Cervantes should have identity section embedded in systemPrompt', () => {
      expect(cervantes.systemPrompt).toContain('## IDENTITÀ E STILE');
      // The knowledge base should contain biographical info
