        ...
        <div className="flex gap-3 flex-1">
          <div
            className={cn(
              ...
              isLow ? 'bg-amber-100 dark:bg-amber-800/30' : 'bg-purple-100 dark:bg-purple-800/30',
            )}
          >
            <Gift
              className={cn(
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {isLow ? t('trialBannerTitleLow') : t('trialBannerTitle')}
            </p>
            ...
            <div className="mt-3 flex items-center gap-4 text-xs text-gray-600 dark:text-gray-400">
              <span className="flex items-center gap-1">
                ...
                {t('trialBannerHelpFeature')}
              </span>
              <span className="flex items-center gap-1">
                <Wrench className="w-3.5 h-3.5" />
                {t('trialBannerToolsFeature')}
              </span>
            </div>
          </div>
        </div>
