...
import { withMaterialTitle } from '@/lib/hooks/use-material-content';
...
export function ToolContent({
  ...
  const rawToolData =
    toolCall.status === 'completed' && toolCall.result?.data
      ? toolCall.result.data
      : toolCall.arguments;
  const toolData = withMaterialTitle(toolType, rawToolData);
  ...
  switch (toolType) {
    ...
    case 'calculator':
      return <CalculatorRenderer data={toolData as unknown as CalculatorData} />;
