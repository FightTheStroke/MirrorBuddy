...
import { ACCESSIBILITY_CATEGORIES, type AccessibilityCategory } from './accessibility-categories';
...
export function AccessibilitySettings({ isOpen, onClose }: AccessibilitySettingsProps) {
  ...
  const [selectedCategory, setSelectedCategory] = useState<AccessibilityCategory>('dyslexia');
  const {
    settings,
    resetSettings,
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              >
                <div>
                  ...
                  >
                    {ACCESSIBILITY_CATEGORIES.find((c) => c.id === selectedCategory)?.description}
                  </p>
                </div>
