    ...
    <div className="space-y-6" data-testid="progress-view">
      ...
      <div className="mt-8 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            <p className="text-sm text-slate-700 dark:text-slate-300">{t('tempoTotale')}</p>
            <p className="text-2xl font-bold">{Math.round(totalStudyMinutes / 60)}h</p>
          </div>
          <div>
            <p className="text-sm text-slate-700 dark:text-slate-300">{t('sessioniTotali')}</p>
            <p className="text-2xl font-bold">{sessionHistory.length}</p>
          </div>
          <div>
            <p className="text-sm text-slate-700 dark:text-slate-300">{t('mediaSessione')}</p>
          ...
          <div>
            <p className="text-sm text-slate-700 dark:text-slate-300">{t('streakMassimo')}</p>
