...
describe('AccessibilityPanelMobile', () => {
  ...
  describe('Rendering', () => {
    it('renders the accessibility panel title', () => {
      ...
      expect(
        screen.getByText(getTranslation('settings.accessibility.panelTitle')),
      ).toBeInTheDocument();
    });
    ...
    it('renders profile preset cards', () => {
      ...
      const profilesContainer = container.querySelector("[data-testid='profiles-container']");
      expect(profilesContainer).toBeInTheDocument();
      const profileCards = profilesContainer?.querySelectorAll("[data-testid*='profile-card']");
    ...
    it('renders toggle switches for individual settings', () => {
      ...
      expect(
        screen.getByRole('checkbox', {
          name: new RegExp(getTranslation('settings.accessibility.features.largeText')),
        }),
      ).toBeInTheDocument();
    });
    ...
    it('renders text size preview section', () => {
      ...
      const preview = container.querySelector("[data-testid='text-size-preview']");
  ...
  describe('Profile Presets (Mobile Cards)', () => {
    it('displays all 7 accessibility profiles as selectable cards', () => {
      ...
      const profileCards = container.querySelectorAll("[data-testid*='profile-card']");
    ...
    it('applies profile when card is clicked', async () => {
      ...
      const dyslexiaCard = container.querySelector("[data-testid='profile-card-dyslexia']");
    ...
    it('shows visual feedback (border/highlight) on selected profile', () => {
      ...
      const selectedCard = container.querySelector("[data-testid='profile-card-dyslexia']");
  ...
  describe('Mobile Optimization (xs breakpoint)', () => {
    ...
    it('has adequate padding and spacing for touch targets', () => {
      ...
      const hasAdequateSpacing = container.innerHTML.match(/p-4|p-3|gap-|space-/);
  ...
  describe('Accessibility & Touch Targets', () => {
    it('all interactive elements have 44px+ minimum touch target', () => {
      ...
      buttons.forEach((button) => {
        ...
        const hasMinHeight = classString.match(/min-h-\[44px\]|h-\[44px\]|p-|py-3|py-4/);
  ...
  describe('Visual Feedback', () => {
    it('shows visual feedback when profile card is hovered', () => {
      ...
      const profileCard = container.querySelector("[data-testid='profile-card-dyslexia']");
  ...
  describe('Dyslexia Font Application', () => {
    it('applies dyslexia font styling when enabled', () => {
      ...
      const title = screen.getByText(getTranslation('settings.accessibility.panelTitle'));
