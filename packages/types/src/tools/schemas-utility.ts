...
NON scrivere codice HTML/CSS/JS - descrivi solo l'idea creativa!`,
      parameters: {
        ...
        properties: {
          ...
          concept: {
            type: 'string',
            description:
              'Il concetto educativo da visualizzare (es: moltiplicazione, frazioni, sistema solare)',
          },
          visualization: {
            type: 'string',
            description:
              'DESCRIZIONE CREATIVA di come visualizzare il concetto. Usa metafore, analogie, idee originali. Più dettagli meglio è!',
          },
          interaction: {
            type: 'string',
            description:
              'Come lo studente interagisce: cosa può cliccare, trascinare, cambiare? Cosa succede?',
          },
          wowFactor: {
            type: 'string',
            description:
              'Cosa rende questa demo memorabile e divertente? Animazioni, sorprese, feedback?',
          },
        },
  ...
  },
  {
    ...
    function: {
      name: 'web_search',
      description:
        'Cerca contenuti educativi su web o YouTube. Usa quando lo studente ha bisogno di risorse esterne, video tutorial, o approfondimenti.',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      name: 'search_archive',
      description:
        "Cerca materiali salvati nell'archivio dello studente (mappe mentali, quiz, flashcard, riassunti, demo, compiti). Usa quando lo studente chiede di rivedere qualcosa che ha già creato o quando vuoi recuperare contenuti precedenti per la conversazione.",
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Calcola espressioni matematiche. Usa quando lo studente ha bisogno di risolvere calcoli, verificare operazioni, o fare matematica rapida.',
      parameters: {
        type: 'object',
        properties: {
          expression: {
