...
3. Almeno 2 livelli di profondità`,
            ...
            items: {
              ...
              properties: {
                ...
                parentId: {
                  type: 'string',
                  description:
                    'ID del padre. OMETTI SOLO per rami principali, INCLUDI per sotto-nodi!',
                },
              },
              required: ['id', 'label'],
            },
  ...
  },
  {
    ...
    function: {
      name: 'create_quiz',
      description:
        'Crea un quiz interattivo con domande a risposta multipla. Usa questo strumento quando lo studente vuole testare la sua comprensione o ripassare.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Crea un set di flashcard per il ripasso con spaced repetition. Usa quando lo studente vuole memorizzare definizioni, formule, o concetti.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
  ...
  },
  {
    ...
    function: {
      name: 'create_summary',
      description:
        'Crea un riassunto strutturato di un argomento. Usa quando lo studente chiede una sintesi, un ripasso, o vuole i punti chiave.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
  ...
  },
  {
    ...
    function: {
      name: 'create_diagram',
      description:
        'Crea un diagramma Mermaid (flowchart, sequence, class, ER). Usa per visualizzare processi, algoritmi, o relazioni tra entità.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Crea una linea del tempo per eventi storici o sequenze temporali. Ideale per storia e cronologie.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
