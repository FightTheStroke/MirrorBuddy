...
export const STUDENT_INTERACTION_DEFINITIONS = [
  {
    ...
    function: {
      ...
      description:
        'Apre l\'editor per far SCRIVERE un riassunto allo studente. NON genera contenuto automaticamente. Usa quando lo studente dice "devo fare un riassunto" o vuole scrivere lui stesso. Guida lo studente con il metodo maieutico.',
      parameters: {
        type: 'object',
        properties: {
          topic: {
