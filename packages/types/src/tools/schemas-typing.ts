...
export const TYPING_TOOL_DEFINITIONS = [
  {
    ...
    function: {
      name: 'typing_tutor',
      description:
        'Apri il tool "Impara a Digitare" per aiutare lo studente a migliorare la digitazione. Usa questo strumento quando lo studente vuole imparare o praticare la digitazione.',
      parameters: {
        type: 'object',
        properties: {
          lessonId: {
