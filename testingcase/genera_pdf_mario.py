#!/usr/bin/env python3
"""
Genera PDF completo per Mario con:
- Pagine originali del libro
- Riassunti migliorati (con concetti aggiunti)
- Mappe mentali
- Esercizi con guida passo-passo
...
# Percorsi
PDF_ORIGINALE = "/Users/roberdan/Downloads/Documento scansionato.pdf"
OUTPUT_PDF = "/Users/roberdan/Downloads/FISICA_COMPLETO_MARIO.pdf"
...
def main():
    ...
    # Pagine originali (0 e 1)
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 0, "LE FORZE (1/2)")
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 1, "LE FORZE (2/2)")
    ...
    # Pagine originali (2 e 3)
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 2, "FORZA ELASTICA (1/2)")
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 3, "FORZA ELASTICA (2/2)")
    ...
    # Pagine originali (4)
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 4, "FORZA-PESO")
    ...
    # Pagina originale esercizi (pagina 6 = pag 119)
    aggiungi_pagina_libro(c, PDF_ORIGINALE, 6, "ESERCIZI PAG. 119")
