...
export function CerebralPalsyA11y({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4">Accessibilità Paralisi Cerebrale</h3>
      ...
      <div className="space-y-4">
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, adaptiveDifficulty: !settings.adaptiveDifficulty })}
        />
        ...
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, simplifiedUI: !settings.simplifiedUI })}
        />
        ...
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, customShortcuts: !settings.customShortcuts })}
        />
        ...
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, timeoutExtended: !settings.timeoutExtended })}
        />
      </div>
    </div>
  );
