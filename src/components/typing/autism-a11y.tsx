...
export function AutismA11y({
  ...
  return (
    <div className={cn('space-y-6', settings.reducedMotion && 'reduced-motion')}>
      <div>
      ...
      <div className="space-y-4">
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, reducedMotion: !settings.reducedMotion })}
        />
        ...
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, predictableLayouts: !settings.predictableLayouts })}
        />
        ...
        <SettingCard
          ...
          onToggle={() => onSettingsChange({ ...settings, minimalUI: !settings.minimalUI })}
        />
      </div>
    </div>
  );
