...
export function HeaderVariantC(props: HeaderVariantProps) {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(135deg, ${maestro.color}ee, ${maestro.color}cc)`,
      }}
    >
      <div className="flex items-center gap-4">
            ...
            {VISUALIZER_BARS.map((offset, i) => {
              ...
              const style =
                !isVoiceActive || !isConnected
                  ...
                  : isSpeaking
                    ? {
                        height: base + outputLevel * variance * 22,
                        opacity: 0.6 + outputLevel * 0.4,
                      }
                    : isListening && !isMuted
                      ? {
                          height: base + inputLevel * variance * 26,
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            disabled={!ttsEnabled}
            className={cn(
              "rounded-full h-9 w-9 text-white/80 hover:text-white hover:bg-white/10",
          ...
          <Button
            ...
            size="icon"
            onClick={onClearChat}
            className="rounded-full h-9 w-9 text-white/80 hover:text-white hover:bg-white/10"
          >
