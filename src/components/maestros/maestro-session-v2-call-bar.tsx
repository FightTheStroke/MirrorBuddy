 ...
 * 
 * Layout ottimizzato: header minimale quando non in chiamata, barra completa quando in chiamata.
 * Rimuove VoicePanel laterale per massimizzare lo spazio centrale.
 */
...
import { MaestroSessionHeaderV2 } from './maestro-session-header-v2-call-bar';
...
interface MaestroSessionV2Props {
  maestro: Maestro;
  onClose: () => void;
  initialMode?: 'voice' | 'chat';
}

export function MaestroSessionV2({ maestro, onClose, initialMode = 'voice' }: MaestroSessionV2Props) {
