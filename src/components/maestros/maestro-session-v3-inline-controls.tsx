 ...
 * 
 * Layout ottimizzato: header sempre compatto, controlli audio come barra sottile sotto l'header.
...
import { MaestroSessionHeaderV3 } from './maestro-session-header-v3-inline-controls';
...
interface MaestroSessionV3Props {
  maestro: Maestro;
  onClose: () => void;
  initialMode?: 'voice' | 'chat';
}

export function MaestroSessionV3({ maestro, onClose, initialMode = 'voice' }: MaestroSessionV3Props) {
