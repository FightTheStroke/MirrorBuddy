...
describe('MaterialCard', () => {
  describe('Basic Rendering', () => {
    it('should render material title', () => {
      ...
      expect(screen.getByText('Introduzione alla Matematica')).toBeInTheDocument();
    });
  ...
  describe('Type Display', () => {
    ...
    it('should display flashcard type', () => {
      render(<MaterialCard material={{ ...mockMaterial, type: 'flashcard' }} />);
  ...
  describe('Selection', () => {
    ...
    it('should show deselect label when selected', () => {
      render(<MaterialCard material={mockMaterial} isSelected={true} onSelect={vi.fn()} />);
    ...
    it('should call onSelect with false when deselecting', () => {
      const onSelect = vi.fn();
      render(<MaterialCard material={mockMaterial} isSelected={true} onSelect={onSelect} />);
  ...
  describe('Favorite', () => {
    it('should show favorite button when onToggleFavorite is provided', () => {
      render(<MaterialCard material={mockMaterial} onToggleFavorite={vi.fn()} />);
    ...
    it('should show remove from favorites label when favorited', () => {
      render(<MaterialCard material={mockMaterialWithFavorite} onToggleFavorite={vi.fn()} />);
    ...
    it('should call onToggleFavorite when clicked', () => {
      ...
      render(<MaterialCard material={mockMaterial} onToggleFavorite={onToggleFavorite} />);
    ...
    it('should have filled star when favorited', () => {
      const { container } = render(
        <MaterialCard material={mockMaterialWithFavorite} onToggleFavorite={vi.fn()} />,
      );
  ...
  describe('Context Menu', () => {
    ...
    it('should open menu on click', () => {
      render(<MaterialCard material={mockMaterial} onOpen={vi.fn()} onDelete={vi.fn()} />);
    ...
    it('should show Duplicate option when onDuplicate is provided', () => {
      ...
      expect(screen.getByRole('menuitem', { name: /duplica/i })).toBeInTheDocument();
    });
  ...
  describe('Drag and Drop', () => {
    ...
    it('should call onKeyboardMove on ArrowUp', () => {
      ...
      render(
        <MaterialCard material={mockMaterial} isDraggable={true} onKeyboardMove={onKeyboardMove} />,
      );
  ...
  describe('Compact Mode', () => {
    it('should apply smaller padding in compact mode', () => {
      const { container } = render(<MaterialCard material={mockMaterial} compact={true} />);

      expect(container.firstChild).toHaveClass('p-3');
    });

    it('should apply larger padding in normal mode', () => {
      const { container } = render(<MaterialCard material={mockMaterial} compact={false} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should include selection state in aria-label when selected', () => {
      ...
      const card = screen.getByRole('option');
      expect(card).toHaveAttribute('aria-label', expect.stringContaining('selezionato'));
    });
