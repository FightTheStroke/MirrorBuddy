...
describe('MindmapRenderer', () => {
  it('renders with title from data', () => {
    render(<MindmapRenderer data={{ title: 'Test Mindmap', markdown: '# Root' }} />);
...
describe('FlashcardRenderer', () => {
  ...
  it('shows empty state when no cards', () => {
    ...
    const emptyState = screen.queryByText(/flashcard|empty/i);
    expect(emptyState || screen.queryByRole('status')).toBeTruthy();
  });
...
describe('DemoRenderer', () => {
  it('renders demo title', () => {
    render(<DemoRenderer data={{ title: 'Test Demo', description: 'A test demo' }} />);
    expect(screen.getByText('Test Demo')).toBeInTheDocument();
  });

  it('uses default title when not provided', () => {
    render(<DemoRenderer data={{}} />);
    expect(screen.getByText(getTranslation('tools.demo.label'))).toBeInTheDocument();
  });

  it('renders type label', () => {
    render(<DemoRenderer data={{ type: 'simulation' }} />);
    // Check that simulation type renders (type label may be translated)
    const demoContainer = screen.getByText(getTranslation('tools.demo.label')).closest('div');
...
describe('DiagramRenderer', () => {
  it('renders with code', () => {
    render(<DiagramRenderer data={{ code: 'graph TD; A-->B', title: 'Flow Chart' }} />);
...
describe('TimelineRenderer', () => {
  ...
  it('shows empty state when no events', () => {
    ...
    expect(
      screen.getByText(getTranslation('education.knowledgeHub.timeline.noEvents')),
    ).toBeInTheDocument();
  });
});
...
describe('ImageRenderer', () => {
  it('renders image with url', () => {
    render(<ImageRenderer data={{ url: 'https://example.com/image.jpg', alt: 'Test image' }} />);
...
describe('HomeworkRenderer', () => {
  ...
  it('shows empty state when no tasks', () => {
    ...
    expect(
      screen.getByText(getTranslation('education.knowledgeHub.homework.noTasks')),
    ).toBeInTheDocument();
  });

  it('renders notes when provided', () => {
    render(<HomeworkRenderer data={{ ...mockHomeworkData, notes: 'Remember to show work' }} />);
