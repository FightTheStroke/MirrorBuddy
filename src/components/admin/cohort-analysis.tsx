      ...
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          <span className="text-sm font-normal text-muted-foreground ml-2">
            {t("last")} {data.period.weeksIncluded} {t("weeks")}
          </span>
        </CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                <th className="text-left p-2 font-medium">{t("cohort")}</th>
                <th className="text-center p-2 font-medium">{t("usersLabel")}</th>
                <th className="text-center p-2 font-medium">{t("trial")}</th>
                <th className="text-center p-2 font-medium">{t("active")}</th>
                <th className="text-center p-2 font-medium">{t("ret7d")}</th>
                <th className="text-center p-2 font-medium">{t("ret14d")}</th>
              </tr>
            </thead>
            <tbody>
