...
describe('EmailTemplateEditor', () => {
  it('renders editor in create mode with empty fields', () => {
    ...
    expect(screen.getByPlaceholderText('Corpo email in HTML')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Versione testuale')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Seleziona categoria')).toBeInTheDocument();
  });
  ...
  it('creates new template on save in create mode', async () => {
    ...
    fireEvent.click(screen.getByText(getTranslation('common.save')));
  ...
  it('updates existing template on save in edit mode', async () => {
    ...
    await waitFor(() => {
      expect(mockCsrfFetch).toHaveBeenCalledWith('/api/admin/email-templates/test-id', {
        method: 'PUT',
        body: JSON.stringify({
          name: 'Test Template',
  ...
  it('navigates back on cancel', () => {
    ...
    fireEvent.click(screen.getByText(getTranslation('common.cancel')));
