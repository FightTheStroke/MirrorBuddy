...
describe('ProfileEditorMobile', () => {
  ...
  it('renders the component', () => {
    ...
    expect(screen.getByText(getTranslation('settings.sections.profile'))).toBeTruthy();
  });
  ...
  it('updates name field on input change', async () => {
    render(<ProfileEditorMobile profile={mockProfile} onSave={mockOnSave} />);
    const nameInput = screen.getByDisplayValue(mockProfile.name) as HTMLInputElement;
  ...
  it('shows avatar preview with update capability', () => {
    ...
    render(<ProfileEditorMobile profile={profileWithAvatar} onSave={mockOnSave} />);
  ...
  it('maintains form state during keyboard interaction', async () => {
    render(<ProfileEditorMobile profile={mockProfile} onSave={mockOnSave} />);
    const bioInput = screen.getByDisplayValue(mockProfile.bio) as HTMLTextAreaElement;
