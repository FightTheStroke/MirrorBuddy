...
const accessibilityProfiles = [
  {
    ...
    toggle: (s: AccessibilitySettings) => ({
      ...
      extraLetterSpacing: !s.dyslexiaFont,
      increasedLineHeight: !s.dyslexiaFont,
    }),
  },
  {
    id: "adhd",
    ...
    toggle: (s: AccessibilitySettings) => ({
      adhdMode: !s.adhdMode,
      distractionFreeMode: !s.adhdMode,
      breakReminders: !s.adhdMode,
    }),
  },
  {
    id: "visual",
    ...
    toggle: (s: AccessibilitySettings) => ({
      highContrast: !(s.highContrast && s.largeText),
      largeText: !(s.highContrast && s.largeText),
    }),
  },
  {
    id: "motor",
  ...
  },
  {
    ...
    color: "teal",
    icon: "🧩",
    isActive: (s: AccessibilitySettings) =>
      s.reducedMotion && s.distractionFreeMode,
    toggle: (s: AccessibilitySettings) => ({
      reducedMotion: !(s.reducedMotion && s.distractionFreeMode),
      distractionFreeMode: !(s.reducedMotion && s.distractionFreeMode),
    }),
  },
  {
    id: "auditory",
    ...
    toggle: (s: AccessibilitySettings) => ({
      visualFirstMode: !s.visualFirstMode,
    }),
  },
  {
    id: "cerebral-palsy",
    ...
    icon: "♿",
    isActive: (s: AccessibilitySettings) =>
      s.ttsEnabled && s.largeText && s.keyboardNavigation,
    toggle: (s: AccessibilitySettings) => ({
...
> = {
  ...
  teal: {
    ...
    bgActive: "bg-teal-100 dark:bg-teal-900/40",
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div
                      className={cn(
                        ...
                        isActive
                          ? `${colors.borderActive} bg-current`
                          : "border-slate-300",
                      )}
                    >
          ...
          <Button onClick={onOpenModal} variant="outline" className="w-full">
