...
export function DiagnosticsTab() {
  ...
  const [configCheck, setConfigCheck] = useState<DiagnosticResult>({
    status: "idle",
  });
  const [chatTest, setChatTest] = useState<DiagnosticResult>({
    status: "idle",
  });
  const [voiceTest, setVoiceTest] = useState<DiagnosticResult>({
    status: "idle",
  });
  const [micTest, setMicTest] = useState<DiagnosticResult>({ status: "idle" });
  const [speakerTest, setSpeakerTest] = useState<DiagnosticResult>({
    status: "idle",
  });
