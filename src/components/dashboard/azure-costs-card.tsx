      ...
      <Card className={cn('overflow-hidden', className)}>
        ...
        <CardContent>
          <div className="text-center py-8 text-slate-500">
            <p className="text-sm">Non disponibile</p>
            <p className="text-xs mt-2">Autenticazione Azure non configurata</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          {topServices.length > 0 && (
            <div>
              <h4 className="text-xs font-semibold text-slate-500 mb-2">Top servizi</h4>
