            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  {kit.subject && (
                    <p className="text-sm text-slate-600 dark:text-slate-400">{kit.subject}</p>
                  )}
                  ...
                  <div className="flex items-center gap-3 mt-2 text-xs text-slate-500">
                    ...
                    {kit.pageCount && (
                      <span>
                        {kit.pageCount} {t('pages')}
                      </span>
                    )}
                    {kit.status === 'ready' && (
                      <span className="text-green-600 dark:text-green-400">
                        {[kit.summary, kit.mindmap, kit.demo, kit.quiz].filter(Boolean).length}{' '}
                        {t('materiali')}
                      </span>
                    )}
                  </div>
                ...
                <div className="ml-4 flex items-center gap-2">
                  {kit.status === 'ready' && (
                    <Button variant="outline" size="sm" onClick={() => onSelect?.(kit)}>
