...
describe('WebcamError', () => {
  it('should display permission denied error with instructions', () => {
    ...
    expect(screen.getByText(/Clicca l'icona.*nella barra degli indirizzi/i)).toBeInTheDocument();
  ...
  it('should display timeout error', () => {
    ...
    render(<WebcamError error="Timeout" errorType="timeout" onRetry={onRetry} onClose={onClose} />);
  ...
  it('should call onRetry when retry button is clicked', async () => {
    ...
    const retryButton = screen.getByRole('button', {
      name: getTranslationRegex('tools.webcam.errors.retry'),
    });
  ...
  it('should call onClose when close button is clicked', async () => {
    ...
    const closeButton = screen.getByRole('button', {
      name: getTranslationRegex('tools.webcam.errors.close'),
    });
