    ...
    <div className="p-3 rounded-lg bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700">
      ...
      <div className="ml-9 space-y-2">
        ...
        {/* Note: step.visual is generated by formatNumberColored(), which produces controlled HTML
            limited to span tags and inline styles. The numeric values it displays are derived from
            user-provided expressions (evaluated/sanitized server-side), but sanitized for defense-in-depth. */}
        {step.visual && (
          <div
            className="text-sm"
            dangerouslySetInnerHTML={{ __html: sanitize(step.visual) }}
          />
        )}
