 ...
 */
export function applyVisualImpairmentProfile(settings: AccessibilitySettings): AccessibilitySettings {
  return {
    ...settings,
    highContrast: true,
    largeText: true,
 ...
 */
export function applyMotorImpairmentProfile(settings: AccessibilitySettings): AccessibilitySettings {
  return {
    ...settings,
 ...
 */
export function applyAuditoryImpairmentProfile(settings: AccessibilitySettings): AccessibilitySettings {
  return {
    ...settings,
