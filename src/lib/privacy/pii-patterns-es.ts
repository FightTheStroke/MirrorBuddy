...
export const ES_PATTERNS: PIIPatternCategory = {
  ...
  address: [
    ...
    /\b(?:[Cc]alle|[Cc]\/|[Aa]venida|[Aa]vda\.|[Pp]aseo|[Pp]laza|[Pp]za\.|[Cc]amino|[Cc]arretera)\s+(?:de\s+(?:la|los|las)\s+|del\s+)?[\p{L}\s'-]+(?:\d+)?/giu,
  ],
