...
describe('Vector Store Service', () => {
  ...
  describe('searchSimilar', () => {
    it('should return results sorted by similarity', async () => {
      ...
      mockPrisma.contentEmbedding.findMany.mockResolvedValueOnce(storedEmbeddings);
  ...
  describe('deleteEmbeddings', () => {
    it('should delete embeddings by sourceId', async () => {
      mockPrisma.contentEmbedding.deleteMany.mockResolvedValueOnce({ count: 3 });
    ...
    it('should delete all embeddings of a type', async () => {
      mockPrisma.contentEmbedding.deleteMany.mockResolvedValueOnce({ count: 10 });
  ...
  describe('VectorSearchResult interface', () => {
    it('should have correct structure', async () => {
      ...
      mockPrisma.contentEmbedding.findMany.mockResolvedValueOnce([storedEmbedding]);
