...
describe("webcam-handler", () => {
  ...
  describe("input validation", () => {
    it("validates data URL format", () => {
      ...
      expect(
        validDataUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeTruthy();
    });
    ...
    it("accepts jpeg data URL", () => {
      ...
      expect(
        jpegUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeTruthy();
    });
    ...
    it("accepts jpg data URL", () => {
      ...
      expect(
        jpgUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeTruthy();
    });
    ...
    it("accepts png data URL", () => {
      ...
      expect(
        pngUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeTruthy();
    });
    ...
    it("accepts gif data URL", () => {
      ...
      expect(
        gifUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeTruthy();
    });
    ...
    it("rejects webp data URL", () => {
      ...
      expect(
        webpUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeFalsy();
    });
    ...
    it("rejects non-image data URL", () => {
      ...
      expect(
        textUrl.match(/^data:image\/(jpeg|jpg|png|gif);base64,/),
      ).toBeFalsy();
    });
  });
