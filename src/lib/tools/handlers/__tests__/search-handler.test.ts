...
describe('Search Handler', () => {
              ...
              search: [
                {
                  title: 'Test',
                  pageid: 1,
                  snippet: '<span class="searchmatch">bold</span> text <b>here</b>',
                },
              ],
            },
          }),
  ...
  describe('web_search handler', () => {
    ...
    it('should return error for non-string query', async () => {
      const result = await executeToolCall('web_search', { query: 123 }, defaultContext);
    ...
    it('should return error for query too short', async () => {
      const result = await executeToolCall('web_search', { query: 'a' }, defaultContext);
