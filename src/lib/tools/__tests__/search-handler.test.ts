...
import { performWebSearch, performYouTubeSearch } from '../handlers/search-handler';
...
describe('search-handler', () => {
          ...
          search: [
            {
              ...
              pageid: 12345,
              snippet: 'Il <span class="highlight">teorema</span> di Pitagora...',
            },
            {
              title: 'Pitagora',
              pageid: 12346,
  ...
  describe('performYouTubeSearch', () => {
    ...
    it('should properly encode query in YouTube URLs', async () => {
      ...
      expect(results[0].url).toContain(encodeURIComponent('algebra & geometria spiegazione'));
    });
