 ...
 */
export async function startTopic(topicId: string): Promise<{ success: boolean; error?: string }> {
 ...
 */
export async function resetTopic(topicId: string): Promise<{ success: boolean }> {
