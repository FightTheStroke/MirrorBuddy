    ...
    it('should suggest pedagogical order [F-09]', async () => {
      const mockResponse = {
        content: JSON.stringify({
          documentTitle: 'Test',
          topics: [
            { id: 't1', title: 'Basic', description: 'd1', keyConcepts: ['a'], estimatedDifficulty: 'basic', order: 1, textExcerpt: '' },
            { id: 't2', title: 'Advanced', description: 'd2', keyConcepts: ['b'], estimatedDifficulty: 'advanced', order: 2, textExcerpt: '' },
          ],
  ...
  describe('orderTopicsPedagogically', () => {
    it('should sort topics by order field', () => {
      const topics: IdentifiedTopic[] = [
        { id: 't3', title: 'Third', description: '', keyConcepts: [], estimatedDifficulty: 'advanced', order: 3, textExcerpt: '' },
        { id: 't1', title: 'First', description: '', keyConcepts: [], estimatedDifficulty: 'basic', order: 1, textExcerpt: '' },
        { id: 't2', title: 'Second', description: '', keyConcepts: [], estimatedDifficulty: 'intermediate', order: 2, textExcerpt: '' },
      ];
