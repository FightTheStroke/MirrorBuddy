    ...
    <div className="prose prose-slate max-w-none prose-headings:text-slate-900 prose-p:text-slate-700 prose-p:leading-relaxed prose-li:text-slate-700">
      <Section number={1} title="Cosa sono i cookie">
        <p>
          ...
          dispositivo (computer, telefono, tablet). Servono a ricordare informazioni
          utili, come se hai già effettuato l&apos;accesso.
        </p>
        <p>
      ...
      <Section number={2} title="Quali cookie usiamo">
        ...
        <ul>
          <li>
            <strong>Cookie essenziali</strong> - servono per far funzionare l&apos;app
          </li>
          <li>
            <strong>Cookie analytics</strong> - servono a capire se l&apos;app funziona bene
          </li>
        </ul>
      ...
      <Section number={3} title="Cookie essenziali">
        <p>
          Questi cookie sono necessari per usare MirrorBuddy. Non puoi disattivarli
          perché senza di loro l&apos;app non funzionerebbe.
        </p>
        <CookieTable
          cookies={[
            {
      ...
      <Section number={4} title="Cookie analytics">
        <p>
          Questi cookie ci aiutano a capire se MirrorBuddy funziona bene sul
          tuo dispositivo. Li usiamo solo se ci dai il permesso.
        </p>
        <CookieTable
          cookies={[
            {
        ...
        <ul>
          <li>
            <strong>Web Vitals</strong> - metriche tecniche sulla velocità dell&apos;app
          </li>
          <li>
        ...
        <p>
          Per maggiori dettagli, leggi la sezione &quot;Metriche di Performance&quot; nella{' '}
          <a href="/privacy" className="text-blue-600 hover:text-blue-700 underline focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded">
            Privacy Policy
          </a>
          .
        </p>
      ...
      <Section number={5} title="Come gestire i cookie">
        <h3 className="text-xl font-semibold text-slate-900 mt-4 mb-3">
        ...
        <p>
          ...
          Ecco come fare nei browser più comuni:
        </p>
        <ul>
          <li>
        ...
        <div
          ...
          className="pl-4 border-l-2 border-amber-400 bg-amber-50 p-4 rounded-r-lg my-4"
        >
          ...
          <p className="text-slate-700">
            ...
            correttamente. Ti consigliamo di permettere almeno i cookie essenziali.
          </p>
        </div>
      </Section>
      ...
      <Section number={6} title="Cookie di terze parti">
        ...
        <p>
          I nostri servizi tecnici (hosting, database) non installano cookie
          sul tuo dispositivo.
        </p>
      </Section>
      ...
      <Section number={7} title="Per quanto tempo restano">
        ...
        <ul>
          <li>
            <strong>Cookie di sessione</strong> - spariscono quando chiudi il browser
          </li>
          <li>
            <strong>Cookie persistenti</strong> - restano fino alla scadenza (max 1 anno)
          </li>
        </ul>
        <p>
      ...
      <Section number={8} title="Modifiche a questa policy">
        ...
        <ul>
          ...
          <li>Se le modifiche sono importanti, ti chiederemo di accettare di nuovo</li>
        </ul>
      </Section>
      ...
      <Section number={9} title="Link utili">
        ...
        <ul>
          ...
          <li>
            <a href="/terms" className="text-blue-600 hover:text-blue-700 underline focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded">
              Termini di Servizio
            </a>
...
function CookieTable({ cookies }: { cookies: CookieInfo[] }) {
  return (
    <div className="overflow-x-auto my-4">
      <table className="min-w-full border-collapse" role="table" aria-label="Elenco cookie">
        <thead>
          <tr className="bg-slate-100">
            <th scope="col" className="px-4 py-3 text-left text-sm font-semibold text-slate-900 border border-slate-200">
              Nome
            </th>
            <th scope="col" className="px-4 py-3 text-left text-sm font-semibold text-slate-900 border border-slate-200">
              A cosa serve
