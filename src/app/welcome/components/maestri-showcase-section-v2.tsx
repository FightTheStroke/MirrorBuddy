 ...
 *
 * Horizontal carousel without "Il Cuore di MirrorBuddy" badge
 * (value proposition is already in hero section)
 */
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-4 max-w-2xl mx-auto">
        ...
        ogni studente potrà creare i propri professori personalizzati.{" "}
        <a
