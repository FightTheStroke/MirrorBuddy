...
const PRINCIPLES = [
  {
    ...
    description:
      "Ognuno ha il suo modo di imparare. Qui rispettiamo il tuo ritmo e il tuo stile.",
    color:
  ...
  },
  {
    ...
    description:
      "Da Leonardo a Marie Curie, i più grandi geni della storia ti spiegheranno ogni materia.",
  ...
  },
  {
    ...
    title: "Mai da solo",
    description:
      "Coach, compagni virtuali e strumenti pensati per te. Insieme si impara meglio!",
  ...
  },
  {
    ...
    description:
      "Quiz, flashcard, mappe mentali e XP da guadagnare. Studiare diventa un'avventura!",
    color:
      ...
      <CardContent className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {PRINCIPLES.map((principle, index) => (
            ...
            >
              <div
                className={`w-10 h-10 rounded-lg ${principle.color} flex items-center justify-center mb-3`}
              >
        ...
        >
          <p className="text-gray-700 dark:text-gray-300 italic">
            &ldquo;Ricorda, {data.name}: non esiste un modo sbagliato di
            imparare. Io sono qui per aiutarti a trovare il tuo!&rdquo;
          </p>
