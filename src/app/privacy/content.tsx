...
export function PrivacyContent() {
  const s1 = useTranslations("legal.privacy.section1");
  const s2 = useTranslations("legal.privacy.section2");
  const s3 = useTranslations("legal.privacy.section3");
  const s4 = useTranslations("legal.privacy.section4");
  const s5 = useTranslations("legal.privacy.section5");
  const s6 = useTranslations("legal.privacy.section6");
  const s7 = useTranslations("legal.privacy.section7");
  const s8 = useTranslations("legal.privacy.section8");
  const s9 = useTranslations("legal.privacy.section9");
  return (
    <>
      ...
      <Section number={4} title={s4("title")}>
        ...
        <ul>
          <li>
            <strong>Far funzionare l&apos;app</strong> -{" "}
            {s4("items.appFunctionality")}
          </li>
          <li>
            <strong>Personalizzare l&apos;esperienza</strong> -{" "}
            {s4("items.personalization")}
          </li>
          <li>
            <strong>Migliorare MirrorBuddy</strong> - {s4("items.improvement")}
          </li>
          <li>
            <strong>Aiutarti se hai problemi</strong> - {s4("items.support")}
          </li>
        </ul>
      ...
      <Section number={6} title={s6("title")}>
        ...
        <ul>
          <li>
            <strong>Tu</strong> - {s6("items.you")}
          </li>
          <li>
            <strong>I tuoi genitori</strong> - {s6("items.parents")}
          </li>
          <li>
            <strong>Il nostro team</strong> - {s6("items.team")}
          </li>
        </ul>
