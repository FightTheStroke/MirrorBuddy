    ...
    <>
      ...
      <Section number={2} title={s2('title')}>
        ...
        <ul>
          ...
          <li>
            <strong>{s2('itemLabels.conversations')}</strong> - {s2('items.conversations')}
          </li>
          <li>
            <strong>{s2('itemLabels.flashcards')}</strong> - {s2('items.flashcards')}
          </li>
          <li>
            <strong>{s2('itemLabels.progress')}</strong> - {s2('items.progress')}
          </li>
          <li>
            <strong>{s2('itemLabels.settings')}</strong> - {s2('items.settings')}
          </li>
        </ul>
      </Section>
      ...
      <Section number={4} title={s4('title')}>
        ...
        <ul>
          <li>
            <strong>{s4('itemLabels.appFunctionality')}</strong> - {s4('items.appFunctionality')}
          </li>
          <li>
            <strong>{s4('itemLabels.personalization')}</strong> - {s4('items.personalization')}
          </li>
          <li>
            <strong>{s4('itemLabels.improvement')}</strong> - {s4('items.improvement')}
          </li>
          <li>
            <strong>{s4('itemLabels.support')}</strong> - {s4('items.support')}
          </li>
        </ul>
        <p className="text-slate-600 dark:text-gray-400 italic">{s4('disclaimer')}</p>
      </Section>
      ...
      <Section number={6} title={s6('title')}>
        ...
        <p className="text-xs text-slate-600 dark:text-gray-400 mt-3">{s6('extraEUNote')}</p>
      </Section>

      <Section number={7} title={s7('title')}>
        <p>{s7('primary')}</p>
        <p className="mt-2">{s7('transfers')}</p>
        <p className="text-sm text-slate-600 dark:text-gray-400 mt-3">{s7('legalBasis')}</p>
      </Section>
      ...
      <Section number={8} title={s8('title')}>
        ...
        <p className="text-sm text-slate-600 dark:text-gray-400 mt-3">{s8('gdprObligations')}</p>
      </Section>

      <Section number={9} title={s9('title')}>
        <ul>
          <li>
            <strong>{s9('itemLabels.activeAccount')}</strong> - {s9('items.activeAccount')}
          </li>
          <li>
            <strong>{s9('itemLabels.conversations')}</strong> - {s9('items.conversations')}
          </li>
          <li>
            <strong>{s9('itemLabels.webVitals')}</strong> - {s9('items.webVitals')}
          </li>
          <li>
            <strong>{s9('itemLabels.deletedAccount')}</strong> - {s9('items.deletedAccount')}
          </li>
        </ul>
      </Section>
    </>
