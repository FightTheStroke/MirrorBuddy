...
describe('GET /api/admin/email-templates/[id]', () => {
  ...
  it('returns 401 if not authenticated', async () => {
    ...
    const req = new NextRequest('http://localhost:3000/api/admin/email-templates/tpl-1', {
      method: 'GET',
    });
  ...
  it('returns 404 if template not found', async () => {
    ...
    const req = new NextRequest('http://localhost:3000/api/admin/email-templates/tpl-999', {
      method: 'GET',
    });
