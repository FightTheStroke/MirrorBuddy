...
const mockTierAuditLogFindMany = prisma.tierAuditLog.findMany as unknown as Mock;
...
describe('GET /api/admin/audit-logs', () => {
  ...
  it('filters by userId', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/admin/audit-logs?userId=user-123', {
      method: 'GET',
    });
  ...
  it('handles database errors', async () => {
    ...
    mockTierAuditLogFindMany.mockRejectedValueOnce(new Error('Database connection failed'));
