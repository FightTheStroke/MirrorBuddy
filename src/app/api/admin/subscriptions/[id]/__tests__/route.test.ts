...
const mockUserSubscriptionFindUnique = prisma.userSubscription.findUnique as unknown as Mock;
const mockUserSubscriptionUpdate = prisma.userSubscription.update as unknown as Mock;
const mockUserSubscriptionDelete = prisma.userSubscription.delete as unknown as Mock;
...
describe('GET /api/admin/subscriptions/[id]', () => {
  ...
  it('returns 401 if not authenticated', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/admin/subscriptions/sub-123', {
      method: 'GET',
    });
  ...
  it('returns 404 if subscription not found', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/admin/subscriptions/sub-999', {
      method: 'GET',
    });
...
describe('DELETE /api/admin/subscriptions/[id]', () => {
  ...
  it('handles database error on deletion', async () => {
    ...
    mockUserSubscriptionFindUnique.mockRejectedValueOnce(new Error('Database error'));
