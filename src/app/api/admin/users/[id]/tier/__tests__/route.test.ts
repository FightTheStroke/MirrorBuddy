...
const mockTierDefinitionFindUnique = prisma.tierDefinition.findUnique as unknown as Mock;
const mockUserSubscriptionUpsert = prisma.userSubscription.upsert as unknown as Mock;
...
describe('POST /api/admin/users/[id]/tier', () => {
  ...
  it('returns 401 if not authenticated', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/admin/users/user-123/tier', {
      method: 'POST',
