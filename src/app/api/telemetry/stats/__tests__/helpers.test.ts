...
describe('telemetry-stats-helpers', () => {
  ...
  describe('buildFeatureUsageChart', () => {
    ...
    it('counts flashcard events', () => {
      const events = [
        { category: 'education', action: 'flashcard_reviewed' },
      ];
      const result = buildFeatureUsageChart(events);
    ...
    it('counts mindmap events', () => {
      const events = [
        { category: 'education', action: 'mindmap_created' },
      ];
      const result = buildFeatureUsageChart(events);
    ...
    it('counts voice conversation events', () => {
      const events = [
        { category: 'conversation', action: 'voice_started' },
      ];
      const result = buildFeatureUsageChart(events);
    ...
    it('counts chat conversation events', () => {
      const events = [
        { category: 'conversation', action: 'message_sent' },
      ];
      const result = buildFeatureUsageChart(events);
  ...
  describe('buildMaestroPreferencesChart', () => {
    ...
    it('returns top 5 maestros only', () => {
      const sessions = [
        { maestroId: 'm1' }, { maestroId: 'm1' }, { maestroId: 'm1' }, { maestroId: 'm1' }, { maestroId: 'm1' },
        { maestroId: 'm2' }, { maestroId: 'm2' }, { maestroId: 'm2' }, { maestroId: 'm2' },
        { maestroId: 'm3' }, { maestroId: 'm3' }, { maestroId: 'm3' },
        { maestroId: 'm4' }, { maestroId: 'm4' },
        { maestroId: 'm5' },
        { maestroId: 'm6' },
      ];
      const result = buildMaestroPreferencesChart(sessions);
