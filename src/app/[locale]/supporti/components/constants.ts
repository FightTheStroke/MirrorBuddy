...
> = {
  ...
  orange: {
    ...
    activeBg:
      "bg-orange-500 dark:bg-orange-400 text-white dark:text-orange-950",
  },
  cyan: {
  ...
  purple: {
    ...
    activeBg:
      "bg-purple-500 dark:bg-purple-400 text-white dark:text-purple-950",
  },
  indigo: {
    ...
    activeBg:
      "bg-indigo-500 dark:bg-indigo-400 text-white dark:text-indigo-950",
  },
  rose: {
  ...
  emerald: {
    ...
    activeBg:
      "bg-emerald-500 dark:bg-emerald-400 text-white dark:text-emerald-950",
  },
  violet: {
    ...
    activeBg:
      "bg-violet-500 dark:bg-violet-400 text-white dark:text-violet-950",
  },
  pink: {
