...
export const debugPages: DebugPage[] = [
  ...
  // ORPHANED PAGES
  { href: '/welcome', note: 'Onboarding (auto-redirect if not completed)', status: 'ok' },
  { href: '/landing', note: 'Marketing page - ORPHANED', status: 'dead' },
  { href: '/parent-dashboard', note: 'Genitori dashboard standalone - ORPHANED', status: 'dead' },
  { href: '/materiali', note: 'HomeworkHelpView legacy - ORPHANED', status: 'dead' },
