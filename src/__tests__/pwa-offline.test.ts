...
describe('PWA Offline Support', () => {
  // W2 app move (#362): public/ relocated to apps/web/public/.
  ...
  describe('Service Worker', () => {
    ...
    it('should preserve push notification handlers', () => {
      ...
      expect(swContent).toMatch(/addEventListener\(['"]pushsubscriptionchange['"]/);
    });
  });
  ...
  describe('Offline Page', () => {
    ...
    it('should display offline message', () => {
      const content = fs.readFileSync(offlinePath, 'utf-8');
      expect(content.toLowerCase()).toMatch(/offline|you're offline|sem conexão/);
    });
