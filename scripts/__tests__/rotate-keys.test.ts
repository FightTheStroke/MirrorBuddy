...
vi.mock('../../src/lib/security/key-rotation', () => ({
  rotateTokenEncryptionKey: mockRotateTokenKey,
  rotateSessionKey: mockRotateSessionKey,
  rotatePIIEncryptionKey: mockRotatePIIKey,
}));
...
describe('Key Rotation CLI Script', () => {
  ...
  describe('Token Key Rotation', () => {
    it('calls rotateTokenEncryptionKey with correct parameters', async () => {
  ...
  describe('PII Key Rotation', () => {
    it('calls rotatePIIEncryptionKey with correct parameters', async () => {
  ...
  describe('Error Handling', () => {
    it('handles rotation function errors', async () => {
      mockRotateTokenKey.mockRejectedValue(new Error('Decryption failed with old key'));
