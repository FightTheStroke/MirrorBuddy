...
echo ""
echo -e "${YELLOW}⚠ EVIDENCE PACK: Generate before tagging the release${NC}"
echo ""
echo "  npm run release:evidence"
echo ""
echo "For tagged releases (v*), the evidence pack is also generated automatically in CI."
echo ""
