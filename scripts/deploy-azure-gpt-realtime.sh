#!/bin/bash
# ============================================================================
# Deploy gpt-realtime-1.5 in Azure Sweden Central (staging)
#
# Usage:
#   ./scripts/deploy-azure-gpt-realtime.sh
#
...
ACCOUNT_NAME="gpt-realtime-staging"
DEPLOYMENT_NAME="gpt-realtime-2026-02-23"
...
echo -e "${BLUE}Deploying gpt-realtime-1.5 to Azure Sweden Central${NC}"
echo "=========================================="
