...
const FEMALE_MAESTRI = ["curie", "lovelace", "levi-montalcini"];
...
test.describe("Voice Mapping Validation", () => {
  ...
  test("Mozart has alloy voice (not shimmer)", async ({ request }) => {
    ...
    const mozart = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("mozart"),
    );
  ...
  test("Erodoto has echo voice (not ballad)", async ({ request }) => {
    ...
    const erodoto = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("erodoto"),
    );
  ...
  test("Cicerone has echo voice (not ballad)", async ({ request }) => {
    ...
    const cicerone = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("cicerone"),
    );
  ...
  test("Manzoni has echo voice (not coral)", async ({ request }) => {
    ...
    const manzoni = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("manzoni"),
    );
  ...
  test("Leonardo has alloy voice (not coral)", async ({ request }) => {
    ...
    const leonardo = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("leonardo"),
    );
  ...
  test("Ippocrate has echo voice (not coral)", async ({ request }) => {
    ...
    const ippocrate = maestri.find((m: { id: string }) =>
      m.id.toLowerCase().includes("ippocrate"),
    );
