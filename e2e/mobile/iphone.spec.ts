...
test.describe('iPhone SE / iPhone 13 Mobile UX', () => {
  ...
  test('voice panel should be less than 30% of viewport width', async ({ page, mobile }) => {
  ...
  test('chat input should be visible and functional', async ({ page, mobile: _mobile }) => {
    // Maestro buttons are in the main content area (not sidebar)
  ...
  test('header stats are compact on small viewports', async ({ page, mobile: _mobile }) => {
  ...
  test('all touch targets should meet WCAG 2.5.5 minimum', async ({ page, mobile }) => {
  ...
  test('iOS safe area should be respected in sidebar bottom', async ({ page, mobile }) => {
    await mobile.openMobileSidebar();
  ...
  test('landscape orientation should maintain functionality', async ({ page, mobile }) => {
