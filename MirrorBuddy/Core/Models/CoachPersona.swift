...
final class CoachPersona {
    ...
    private func addPlayfulTone(to text: String, sentiment: SentimentDetectionService.Sentiment) -> String {
        ...
        case .enthusiastic:
            return text + " 🎉"
        case .frustrated:
            return "Hey, no worries! " + text + " We'll figure this out together! 💪"
        case .confused:
            return "Ooh, I see! " + text + " Let's break it down step by step! 🤔"
        case .tired:
            return "Taking it slow! " + text + " You're doing great! ⭐"
        case .neutral:
            return text
        }
    }

    private func addCalmTone(to text: String, sentiment: SentimentDetectionService.Sentiment) -> String {
        switch sentiment {
        case .frustrated:
            return "Take a deep breath. " + text + " There's no rush."
        case .confused:
            return "Let me explain gently. " + text
        case .tired:
            return "You're doing well. " + text + " Take your time."
        default:
            return text
        }
    }

    private func addEnthusiasticTone(to text: String, sentiment: SentimentDetectionService.Sentiment) -> String {
        switch sentiment {
        case .enthusiastic:
            return "YES! " + text + " You're on fire! 🔥"
        case .frustrated:
            return "You've got this! " + text + " Keep going! 💪"
        case .confused:
            return "Great question! " + text + " Let's explore!"
        default:
            return text + "!"
        }
    }

    private func addProfessionalTone(to text: String, sentiment: SentimentDetectionService.Sentiment) -> String {
        switch sentiment {
        case .confused:
            return "To clarify: " + text
        case .frustrated:
            return "Let's approach this systematically. " + text
        default:
            return text
        }
    }
